...
--     compile_command = {
--       c = { exec = 'gcc', args = { '-DHAMED', '-Wall', '$(FNAME)', '-O3', '-o', '$(FNOEXT)' } },
--       cpp = { exec = 'g++', args = { '-std=c++17', '-DHAMED', '-Wall', '$(FNAME)', '-O3', '-o', '$(FNOEXT)' } },
...
local function relative_path(task)
  local file_extension = vim.fn.input("Choose file extension (cpp/py): ", "cpp")
